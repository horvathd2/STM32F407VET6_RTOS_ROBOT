...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if(htim_encoder->Instance==TIM2)
  {
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(MOT2_ENC_TIM2CH1_GPIO_Port, MOT2_ENC_TIM2CH1_Pin);

    HAL_GPIO_DeInit(MOT2_ENC_TIM2CH2_GPIO_Port, MOT2_ENC_TIM2CH2_Pin);
  ...
  else if(htim_encoder->Instance==TIM3)
  {
    ...
    PC7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOC, MOT1_ENC_TIM3CH1_Pin|MOT1_ENC_TIM3CH2_Pin);
  ...
  else if(htim_encoder->Instance==TIM4)
  {
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, ROT_ENC_TIM4CH1_Pin|ROT_ENC_TIM4CH2_Pin);
